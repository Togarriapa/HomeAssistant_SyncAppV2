...
assert '--fail-on-warnings' not in sys.argv  # added only by the real trusted helper
...
@pytest.mark.parametrize("body", [
    ...
    "import json,sys; print(json.dumps({'nonce':sys.argv[3],'version':'2026.9.2','result':'passed'}))",
    "import json,sys; print(json.dumps({'nonce':sys.argv[3],'version':sys.argv[2],'result':'invalid'}))",
])
